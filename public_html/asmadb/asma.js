...
ASMA.prototype.playOrStopAtIndex = function(fileIndex, songIndex) {
...
ASMA.prototype.getPlaySongButtonId = function(songIndex) {
...
ASMA.prototype.setCurrentFileIndexAndSong = function(fileIndex, songIndex) {
...
ASMA.prototype.playASMA = function(fileIndex, songIndex) {
...
ASMA.prototype.playSong = function(songIndex) {
...
ASMA.prototype.displayAuthorDetails = function(composerIndex) {
	let fileInfo = this.currentFileInfo;
	if (fileInfo == null) {
		return;
	}
...
ASMA.prototype.displayAuthorSongs = function(composerIndex) {
